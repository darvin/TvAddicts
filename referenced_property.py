...
A quick usage example: 
        ...
        class Holder(db.Model): 
                bits = langutils.ReferenceListProperty(Bit, default=None) 
        b1 = Bit(name="first") 
...
class ReferenceListProperty(db.Property):
    ...
    """
    def __init__(self, item_type, verbose_name=None, default=None,
                 **kwds):
    ...
    def validate(self, value):
        """Validate list. Note that validation here is just as broken as
    for ListProperty.
